    ...
    >
      {project?.image && (
        <div className="project-card__media">
          <img src={project.image} alt={project.title} loading="lazy" width="600" height="400" style={{ width: '100%', height: 'auto', objectFit: 'cover' }} />
        </div>
      )}
          ...
          <div className="project-card__links">
            {project.links.map((link) => (
              <a
                ...
                aria-label={`Link to ${project.title} ${link.text}`}
              >
                {link.text}
                {' '}
                ↗
